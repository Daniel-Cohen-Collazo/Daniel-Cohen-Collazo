...
[![Handshake](https://img.shields.io/badge/Handshake-ABD135?style=for-the-badge&logo=handshake&logoColor=black)](https://utsa.joinhandshake.com/profiles/danielcohencollazo)
...
<img alt="Sales" src="./assets/sales-banner-light.svg" width="100%">
</picture>

## Sales Performance — FY2026 (Feb 2 – Jul 25, 2026)

| Metric | Value |
| --- | --- |
| Overall Sales | **$317,368** *(incl. $32,817 closed, pending disbursement at project completion)* |
| Goal | **$181,384** |
| Above Target | **+$135,984 (+75%)** |
| District Ranking | **#2 of 30 Specialists (top 7%)** |
| Orders Sold | **437** |
| D30 Sales | **$235,001** |
| Measures | **#1 in district (98 of 99)** |
| Store Department | **#1 of 11** |

*Promoted into the specialist seat in Aug 2025 — ranked #2 of 30 district-wide within the first year.*

[![Sales Resume](https://img.shields.io/badge/Sales_Resume-SDR_·_BDR_·_AE-1f883d?style=for-the-badge&logo=readdotcv&logoColor=white)](./Daniel-Cohen-Collazo-Sales-Resume.pdf)

### My Monthly Net Sales (Aug 2025 – Jun 2026)

```mermaid
xychart-beta
   title "Daniel's Monthly Net Sales ($)"
   x-axis ["Aug 25", "Sep 25", "Oct 25", "Nov 25", "Dec 25", "Jan 26", "Feb 26", "Mar 26", "Apr 26", "May 26", "Jun 26"]
   y-axis "Net Sales ($)" 0 --> 65000
   bar [7347, 21520, 24836, 33008, 29388, 6468, 35921, 58713, 39068, 52017, 52536]
```
...
<img alt="Technical" src="./assets/tech-banner-dark.svg" width="100%">
</picture>
